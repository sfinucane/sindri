# -*- coding: utf-8 -*-
"""
    sindri.agilent.common
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    Implements functionality which is commonly found in Agilent instruments.
...
class ErrorQueueImplementation():
    """Provide functionality for Agilent instruments with error queues.

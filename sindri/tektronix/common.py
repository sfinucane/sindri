# -*- coding: utf-8 -*-
"""
    sindri.tektronix.common
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    Implements functionality which is commonly found in Tektronix instruments.

    Sources::

        - Tektronix Inc. `link <http://www.tek.com>`_
...
class ErrorQueueImplementation():
    """Provide functionality for Tektronix instruments with error queues.
